...
import { formatDateTime, timeAgo, toPercent } from "../../utils/formatters";
      ...
      <div className="row g-4">
        ...
        <div className="col-12 col-xl-4">
          <div className="stack-4">
            ...
            <Card padding="lg">
              <CardHeader title="Problem Cluster" />
              <div className="info-grid info-grid--single">
                <Row icon="bi-diagram-3" label="Problem Cluster">
                  {complaint.problemClusterId ?? "—"}
                </Row>
                <Row icon="bi-files" label="Related Reports">
                  {complaint.duplicateAnalysis?.relatedComplaints?.length ?? 0}
                </Row>
                <Row icon="bi-percent" label="Similarity">
                  {complaint.duplicateAnalysis ? toPercent(complaint.duplicateAnalysis.similarity) : "—"}
                </Row>
                <Row icon="bi-tags" label="Common Issue">
                  {complaint.categoryLabel || complaint.issueType || "—"}
                </Row>
                <Row icon="bi-geo-alt" label="Location">
                  {complaint.location}
                </Row>
              </div>
              <Button variant="secondary" icon="bi-diagram-3" block className="mt-3" to={PATHS.OFFICER_COMPLAINTS}>
                View Cluster
              </Button>
            </Card>
